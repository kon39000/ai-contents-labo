...
export default function HeroSectionImproved() {
  return (
    <section className="relative bg-gradient-to-br from-white to-orange-50 section-large overflow-hidden">
      {/* 改善された背景装飾 - 視覚ノイズを軽減 */}
      ...
      <div className="container-max relative">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="card card-hover border border-orange-100">
            ...
            <div className="card card-hover border border-cyan-100">
              <div className="text-3xl mb-3" aria-hidden="true">⚡</div>
            ...
            <div className="card card-hover border border-purple-100">
              <div className="text-3xl mb-3" aria-hidden="true">🚀</div>
